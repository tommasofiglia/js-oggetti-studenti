...
document.getElementById('dati_studenti').innerHTML = "<ul><li>  Nome: " + romina.Nome + "</li> <li> Cognome: " + romina.Cognome + "</li> <li> Età: " + romina.Età + "</li> </ul>" + "<ul><li>  Nome: " + mariapia.Nome + "</li> <li> Cognome: " + mariapia.Cognome + "</li> <li> Età: " + mariapia.Età + "</li> </ul>" + "<ul><li>  Nome: " + tommaso.Nome + "</li> <li> Cognome: " + tommaso.Cognome + "</li> </ul>" + "<ul><li>  Nome: " + nuovoUtente.Nome + "</li> <li> Cognome: " + nuovoUtente.Cognome + "</li> </ul>";
